...
import org.avidd.foundry.bitcask.BitcaskKVStore;
...
public class Main {
  ...
  static class FoundryServer {
    ...
    public FoundryServer apiKey(String apiKey) {
      this.apiKey = apiKey;
      return this;
    }
    ...
    public FoundryServer start() throws IOException {
      ...
      if ( this.apiKey == null || this.apiKey.isBlank() ) {
        throw new IllegalStateException(ENV_API_KEY + " must be set");
      }
